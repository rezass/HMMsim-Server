...
bool CompressedTraceReader::TraceMerger::readEntry(uint64 *timestamp, addrint *addr, uint8 *size, bool mocked) {
   ...
   /* if (testFileRead / 4 == 0) {
        ...
        *addr = 8192;
    } else if (testFileRead / 4 == 2) {
        *addr = 16384;
    } else if (testFileRead / 4 == 3) {
        *addr = 32768;
    } else if (testFileRead / 4 == 4) {
        *addr = 65536;
    } else if (testFileRead / 4 == 5) {
        *addr = 131072;
    } else if (testFileRead / 4 == 6) {
        *addr = 262144;
    } else if (testFileRead / 4 == 7) {
        *addr = 524288;
    } else if (testFileRead / 4 == 8) {
        *addr = 1048576;
    } else if (testFileRead / 4 == 9) {
        *addr = 2097152;
    } else if (testFileRead / 4 == 10) {
        *addr = 4194304;
    } else if (testFileRead / 4 == 11) {
        *addr = 8388608;
    } else if (testFileRead / 4 == 12) {
        *addr = 8392704;
    } else if (testFileRead / 4 < 150) {
        *addr = 4194304;
